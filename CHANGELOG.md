...
| 频率 | 08:26 之前（KPH California） | 08:26 之后（HB3YQQ 瑞士，5.5h） |
|------|------|------|
| 8992 / 11175 / 15016 kHz | 都在出信号 | **各 0 条** |
| 4724 kHz | 在出信号 | 76 条，其中 71 条判定 NOISE，中位带内 SNR **-5.6 dB** |
...
- **节点择优改成按历史接收质量分档**，延迟降为同档内的平手判据：
  ...
  - 影响文件：`src/node_manager.py`, `src/receiver.py`, `src/db.py`
